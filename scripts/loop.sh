...
#
# Config (env):
#   LOOP_SOURCES       space-separated sources        (default: "gists commoncrawl")
...
SOURCES="${LOOP_SOURCES:-gists commoncrawl}"
LIMIT="${LOOP_LIMIT:-50}"
...
batches=0
round=0
echo "[loop] sources: $SOURCES | limit: $LIMIT | sleep: ${SLEEP_S}s | iters: ${ITERS:-inf}"
while :; do
